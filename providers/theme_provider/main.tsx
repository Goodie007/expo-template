...
import { EmotionTheme, EmotionThemeName, ExtendEmotionTheme } from "@/theme";
//import { EmotionThemeName } from '@/theme';
...
export const ThemeModesProvider = ({
  extendTheme,
  children,
  ...
  useEffect(() => {
    getItem().then((theme) => {
      if (theme) {
        const defaultTheme = theme === "dark" ? darkTheme : lightTheme;
