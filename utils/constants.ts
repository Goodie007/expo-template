...
export const app_storage = "@app-template.local.storage";
export const app_theme_color_storage = "@app-template.theme.local.storage";

// live url as default
export const baseUrl =
  process.env.API_URL ?? API_URL ?? "https://baseUrl";
